...
--
-- Note: The deph of the hierarchy is not fixed and can be different for each destination, but with a maximum of 5 levels.

SELECT
    id AS destination_id,
    name AS destination_name,
    -- TODO: Add the parents destinations
FROM
